namespace Fusion.Menu {
  ...
  using UnityEngine;
    ...
    /// </summary>
    protected virtual async void OnQuickPlayButtonPressed() {
	...
	{
		ConnectionArgs.Session = string.IsNullOrEmpty(_roomName.text) ? "Sandbox" : _roomName.text;
		ConnectionArgs.Creating = false;
		ConnectionArgs.Region = ConnectionArgs.PreferredRegion;
	...
	/// Intitiates the connection and expects the connection object to set further screen states.
	/// </summary>
	protected virtual async void OnHostButtonPressed()
	{
		ConnectionArgs.Session = string.IsNullOrEmpty(_roomName.text) ? "Sandbox" : _roomName.text;
